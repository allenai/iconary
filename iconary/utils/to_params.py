...
def to_params(obj: FromParams, source_cls) -> Dict[str, Any]:
  ...
  I hate writing json config files by hand, so this method provides a way to define the
  python objects in code and then extract the params/config from them afterwards.
